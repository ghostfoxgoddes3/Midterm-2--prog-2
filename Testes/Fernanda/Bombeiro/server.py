import mesa
from agent import TreeCell, CityCell, GrassCell, Person, GroundFirefighter  # Importando as classes TreeCell, CityCell e GrassCell
...
COLORS = {
    ...
    "GroundFirefighter": "#ff00e6" # Cor do bombeiro
}
